...
char* writebase2(FILE *phddfile, char* pfilename, struct word *pmemword, int countnumword)//
																						  ...
																						  //pfilename - указ уже сформированное ранее имя ф-ла для hdd
													...
													//psize-указ на пер-ю числ  элем-тов в масс - уменьшается при повторяюцихся словах 
{
 ...
 ////////===========  ф залержки ms и возврат key или возвр наж кл-ши =============///// 
char delayorkey(int ms, char key) // ф залержки ms и возврат key или возвр код наж кл-ши
{
	//blok time or KEY
	printf("clock = %d\n", clock());
	//int ms = 5000;
