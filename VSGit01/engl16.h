...
#ifndef ENGL09_H 
#define ENGL09_H
#define NAMEENGLTEXT 64 // max размер ИМЕНИ файла англ текста 
...
char delayorkey(int ms, char key); // ф залержки ms и возврат key или 
...
struct ininame       // стр для хранения имён файлов и другой инфы
{				//будут и другие поля;
	int idname;
	char textname[EN1];    //имя файла англ текста 
